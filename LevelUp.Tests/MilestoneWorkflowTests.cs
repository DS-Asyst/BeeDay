...
public sealed class MilestoneWorkflowTests
{
    ...
    public void CompletingLastQuestCompletesMilestoneAndActivatesNext()
    {
        ...
        var project = context.Projects.CreateProject("Project", "Description", "Reward");
        ...
        Assert.Equal(second.Id, result.ActivatedMilestone?.Id);
    }
    ...
    public void CompletingBossMilestoneRequirementsUnlocksBossWithoutCompletingMilestone()
    {
        ...
        var project = context.Projects.CreateProject("Project", "Description", "Reward");
        context.Projects.ActivateProject(project);
        var milestone = context.Milestones.CreateMilestone(project, "Milestone", "Description", 1);
        context.Milestones.Activate(milestone);
        var boss = context.Bosses.Create(project, milestone, "Boss", "Description", true);
        var quest = context.Quests.CreateQuest("Quest", "Description", project);
    ...
    public void DefeatingAvailableBossCompletesMilestoneAndProject()
    {
        ...
        var result = context.BossWorkflow.Defeat(milestone.Id);
