...
/// limiter. Overrides the generous defaults in <see cref="BeeDayWebApplicationFactory"/> with
...
/// </summary>
public sealed class RateLimitingWebApplicationFactory : BeeDayWebApplicationFactory
{
