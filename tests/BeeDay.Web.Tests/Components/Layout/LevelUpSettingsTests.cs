...
public sealed class LevelUpSettingsTests
{
    ...
    public void SettingsSectionRendersHeaderAndChildContent()
    {
        ...
        var cut = context.Render<LevelUpSettingsSection>(parameters => parameters
    ...
    public async Task SettingsFormInvokesOnValidSubmitAndShowsSubmitLabel()
    {
        ...
        var cut = context.Render<LevelUpSettingsForm<DummyModel>>(parameters => parameters
