...
public sealed class LevelUpFormTests
{
    ...
    public void InputRendersLabelRequiredMarkerAndAttributes()
    {
        ...
        var cut = RenderInsideEditContext<LevelUpInput>(context, model, parameters => parameters
    ...
    public void TextAreaRendersCounter()
    {
        ...
        var cut = RenderInsideEditContext<LevelUpTextArea>(context, model, parameters => parameters
    ...
    public void CheckboxRendersLabelAndInvokesValueChanged()
    {
        using var context = new BunitContext();
        var model = new FormTestModel();
        var cut = RenderInsideEditContext<LevelUpCheckbox>(context, model, parameters => parameters
    ...
    public void DateInputRendersAndInvokesValueChanged()
    {
        using var context = new BunitContext();
        var model = new FormTestModel();
        var cut = RenderInsideEditContext<LevelUpDateInput<DateTime?>>(context, model, parameters => parameters
    ...
    public void SelectRendersOptionsAndInvokesValueChanged()
    {
        ...
        var cut = RenderInsideEditContext<LevelUpSelect<string>>(context, model, parameters => parameters
