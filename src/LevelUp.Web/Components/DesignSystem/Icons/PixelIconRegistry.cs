    ...
    private static readonly IReadOnlyDictionary<PixelIconName, PixelIconDefinition> Definitions =
        new ReadOnlyDictionary<PixelIconName, PixelIconDefinition>(
            new Dictionary<PixelIconName, PixelIconDefinition>
            {
                ...
                [PixelIconName.Account] = Define("user", "material-symbols/character/user.svg", PixelIconCategory.Navigation, "Account"),
                ...
                [PixelIconName.Inventory] = Define("inventory", "material-symbols/inventory/inventory.svg", PixelIconCategory.Navigation, "Inventory"),
                ...
                [PixelIconName.Character] = Define("character", "material-symbols/character/character.svg", PixelIconCategory.Navigation, "Character"),
