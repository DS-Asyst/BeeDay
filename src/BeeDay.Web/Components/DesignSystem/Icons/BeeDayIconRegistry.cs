    ...
    private static readonly IReadOnlyDictionary<BeeDayIconName, BeeDayIconDefinition> Definitions =
        new ReadOnlyDictionary<BeeDayIconName, BeeDayIconDefinition>(
            new Dictionary<BeeDayIconName, BeeDayIconDefinition>
            {
                ...
                [BeeDayIconName.Home] = Define("home", "lucide/navigation/home.svg", BeeDayIconCategory.Navigation, "Home"),
                ...
                [BeeDayIconName.Attribute] = Define("attribute", "lucide/actions/attribute.svg", BeeDayIconCategory.Actions, "Attribute"),
