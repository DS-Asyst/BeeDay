...
public sealed partial class InventoryTag : Entity
{
    ...
    public static InventoryTag Create(Guid userId, string name, string? color = null)
    {
        ...
        var tag = new InventoryTag { UserId = userId };
