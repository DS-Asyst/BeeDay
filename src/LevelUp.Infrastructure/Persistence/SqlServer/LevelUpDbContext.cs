...
internal sealed class LevelUpDbContext(DbContextOptions<LevelUpDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ambiguity — confirmed empirically in Sprint 14.2 by LevelUpDbContextTests, which already
        ...
        // then throws ("already configured as non-owned") — confirmed by LevelUpDbContextTests during
        ...
        // (confirmed by LevelUpDbContextTests during this Sprint). UserExperience still needs
