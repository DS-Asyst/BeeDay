...
/// docs/history/domain-aggregate-map.md §2.7. Filtered/paginated/sorted transaction listings
...
/// (docs/history/target-architecture-sprint-log.md §4). <see cref="ListByTagAsync"/> exists to support
/// clearing tag references when a <c>WalletTag</c> is deleted (see
/// docs/history/domain-persistence-map.md §2.8).
/// </summary>
