...
{
    public EfHabitRepository(IDbContextFactory<LevelUpDbContext> contextFactory) : base(contextFactory)
    {
    }

    internal EfHabitRepository(LevelUpDbContext sharedContext) : base(sharedContext)
    {
    }
