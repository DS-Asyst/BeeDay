...
{
    public EfWalletRepository(IDbContextFactory<BeeDayDbContext> contextFactory) : base(contextFactory)
    {
    }

    internal EfWalletRepository(BeeDayDbContext sharedContext) : base(sharedContext)
    {
    }
