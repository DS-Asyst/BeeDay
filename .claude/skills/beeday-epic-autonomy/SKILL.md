...
description: "Execute an explicitly autonomous BeeDay Epic containing multiple Sprints. Use only when the user grants AUTONOMY: EPIC or unmistakably authorizes Claude to implement, validate, commit, push, and create PRs for all defined Sprints without waiting between them."
