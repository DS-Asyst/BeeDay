...
- Busca `@page` em `src/BeeDay.Web/Components/**/*.razor` (18 ocorrências, 17 arquivos — contagem
  inalterada após a Sprint 20.5: `Entry.razor` removido, `Features/Home/Pages/Home.razor` criado).
