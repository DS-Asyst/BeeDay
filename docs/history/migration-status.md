...
[`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.2/§0.4. The migration was
...
[`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.5.
...
updated with the new components. See [`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md)
§0.6.
...
[`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.7 and
[`07-persistence-contracts.md`](persistence-contracts.md) §14.
...
[`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.5 for the write-strategy
...
them. Full detail: [`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.2/§0.4, and
[`docs/data/01-relational-model.md`](../persistence/01-relational-model.md) §5.8 and the `Projects`/
...
[`docs/data/02-ef-core-strategy.md`](../persistence/02-ef-core-strategy.md) §0.6.
