...
| [`epics/25-design-system-brand-evolution/`](epics/25-design-system-brand-evolution/README.md) | EPIC 25 — beeday Design System & Brand System Evolution: contrato de marca, governança do Design System, taxonomia de decisão, roadmap de Sprints | Em andamento — iniciado na Sprint 25.1 |
