...
**Fonte de verdade usada:** [`docs/architecture/05-domain-aggregate-map.md`](../history/domain-aggregate-map.md)
e [`docs/architecture/06-domain-persistence-map.md`](../history/domain-persistence-map.md), ambos
