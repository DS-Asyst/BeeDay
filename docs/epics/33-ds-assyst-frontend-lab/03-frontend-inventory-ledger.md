...
|---|---|---|---|---|---|---|---:|---|---|---|
| FE33-001 | Foundation | `src/BeeDay.Web/wwwroot/css/design-system.css` (cores/semantic colors) | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | Paleta + tokens semânticos; `#5247F9` = brand oficial (ADR de marca, EPIC 25). |
| FE33-002 | Foundation | tipografia (fontes Google `Inter`/`Jersey 25`, escala) | `acce26a` | Google Fonts (externo, permitido para artifacts/Lab per política de fontes) | COPY | `<LabWeb>/wwwroot/css/*` | 33.6 | MAPPED | `docs/design-system/01-foundations.md`; `docs/web/02-routing-and-pages.md` §2 | Carregadas via `App.razor`. |
| FE33-003 | Foundation | tokens de spacing | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | |
| FE33-004 | Foundation | tokens de border-radius | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | |
| FE33-005 | Foundation | tokens de elevação/sombra | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | |
| FE33-006 | Foundation | breakpoints (literais, não CSS custom properties) | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/*` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` §10; `docs/ux/03-responsive.md` | Literais por design (CSS vars inválidas em media features) — preservar como estão, não "corrigir" durante extração. |
| FE33-007 | Foundation | tokens de motion (duration/easing) | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | |
| FE33-008 | Foundation | grid/z-index/layout primitives | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/css/design-system.css` | 33.6 | MAPPED | `docs/design-system/01-foundations.md` | |

## Asset (Sprint 33.7)

| ID | Area | Production path | Production source SHA | Runtime dependencies | Strategy | Lab path | Owning Sprint | State | Evidence | Notes |
|---|---|---|---|---|---|---|---:|---|---|---|
| FE33-009 | Asset | `wwwroot/icons/sprite.svg` + `BeeDayIconRegistry` + `design/icons/catalog/icon-mapping.csv` | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/icons/sprite.svg` | 33.7 | MAPPED | `docs/design-system/03-icons.md` | Ícones funcionais Lucide, sprite estático local, sem CDN. |
| FE33-010 | Asset | 6 ícones de marca social (vetores próprios) | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/icons/sprite.svg` | 33.7 | MAPPED | `docs/design-system/03-icons.md` | `fill: currentColor`, mantidos fora do padrão Lucide outline. |
| FE33-011 | Asset | ilustrações/personagens/mascote (Brand System, EPIC 25.13) | `acce26a` | licenciamento a confirmar | COPY / EXCLUDE (por item) | `<LabWeb>/wwwroot/assets/` | 33.7 | MAPPED | `docs/brand/`; `docs/epics/25-design-system-brand-evolution/README.md` Sprint 25.13 | Estratégia final por asset depende de auditoria de licença/origem na própria Sprint 33.7 — não assumida aqui. |
| FE33-012 | Asset | logos/wordmarks oficiais | `acce26a` | nenhuma | COPY | `<LabWeb>/wwwroot/assets/` | 33.7 | MAPPED | `docs/brand/`; `Components/DesignSystem/Text/BeeDayBrand.razor` | Consumidos hoje via `<BeeDayBrand />`, não markup próprio (ver `docs/web/README.md` "Achados"). |

## Component (Sprint 33.8)

| ID | Area | Production path | Production source SHA | Runtime dependencies | Strategy | Lab path | Owning Sprint | State | Evidence | Notes |
|---|---|---|---|---|---|---|---:|---|---|---|
| FE33-013 | Component | `Components/DesignSystem/Buttons/BeeDayButton.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Buttons/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-014 | Component | `Components/DesignSystem/Cards/BeeDayCard.razor(.cs)` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Cards/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-015 | Component | `Components/DesignSystem/Feedback/BeeDayConfirmDialog.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-016 | Component | `Components/DesignSystem/Feedback/BeeDayDashboardSkeleton.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Estado "loading" do Dashboard. |
| FE33-017 | Component | `Components/DesignSystem/Feedback/BeeDayEmptyState.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Estado "empty" canônico. |
| FE33-018 | Component | `Components/DesignSystem/Feedback/BeeDayErrorBoundary.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Estado "error" canônico. |
| FE33-019 | Component | `Components/DesignSystem/Feedback/BeeDayLoading.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Usado também por `Routes.razor` (`Authorizing`). |
| FE33-020 | Component | `Components/DesignSystem/Feedback/BeeDaySkeleton.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-021 | Component | `Components/DesignSystem/Feedback/BeeDayToastHost.razor` | `acce26a` | `ToastService` (Web-side) | ADAPT | `<LabWeb>/Components/DesignSystem/Feedback/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Substituir `ToastService` real por estado local do Lab. |
| FE33-022 | Component | `Components/DesignSystem/Forms/BeeDayCheckbox.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | |
| FE33-023 | Component | `Components/DesignSystem/Forms/BeeDayDateInput.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | |
| FE33-024 | Component | `Components/DesignSystem/Forms/BeeDayInput.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | |
| FE33-025 | Component | `Components/DesignSystem/Forms/BeeDaySelect.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | |
| FE33-026 | Component | `Components/DesignSystem/Forms/BeeDayTextArea.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | |
| FE33-027 | Component | `Components/DesignSystem/Forms/BeeDayValidationMessage.razor` | `acce26a` | `ValidationMessageLocalizer` (Web) | ADAPT | `<LabWeb>/Components/DesignSystem/Forms/` | 33.8 | MAPPED | `docs/design-system/04-forms.md` | Mensagens localizadas estáticas no Lab, sem o localizer real de validação de domínio. |
| FE33-028 | Component | `Components/DesignSystem/Icons/BeeDayIcon.razor` | `acce26a` | `BeeDayIconRegistry` (ver FE33-009) | COPY | `<LabWeb>/Components/DesignSystem/Icons/` | 33.8 | MAPPED | `docs/design-system/03-icons.md` | |
| FE33-029 | Component | `Components/DesignSystem/Layout/BeeDayHero.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Layout/` | 33.8 | MAPPED | `docs/design-system/02-components.md`; `docs/web/02-routing-and-pages.md` §9 | Inclui parâmetros `HeaderNav`/`Eyebrow`/`BrandContext` (Sprint 29.4). |
| FE33-030 | Component | `Components/DesignSystem/Layout/BeeDayPageHeader.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Layout/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-031 | Component | `Components/DesignSystem/Layout/BeeDaySectionHeader.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Layout/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-032 | Component | `Components/DesignSystem/Layout/BeeDaySettingsForm.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Layout/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-033 | Component | `Components/DesignSystem/Layout/BeeDaySettingsSection.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Layout/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-034 | Component | `Components/DesignSystem/Modals/EditorModalShell.razor(.cs)` | `acce26a` | `DialogFocusScope`, `beeday-dialog-focus.js` (ver FE33-109) | ADAPT | `<LabWeb>/Components/DesignSystem/Modals/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | Base dos 4 editores de atividade (ver FE33-091..094). |
| FE33-035 | Component | `Components/DesignSystem/Progress/BeeDayProgressBar.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Progress/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-036 | Component | `Components/DesignSystem/Text/BeeDayBrand.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Text/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-037 | Component | `Components/DesignSystem/Text/SearchHighlight.razor` | `acce26a` | nenhuma | COPY | `<LabWeb>/Components/DesignSystem/Text/` | 33.8 | MAPPED | `docs/design-system/02-components.md` | |
| FE33-038 | Component | `Components/Behaviors/DragDrop/BeeDaySortable.cs` + `beeday-sortable.js` | `acce26a` | `DashboardState.Reorder*Async` (Application via `SortableOrder.Move`) | ADAPT | `<LabWeb>/Components/Behaviors/DragDrop/` | 33.8 | MAPPED | `docs/design-system/02-components.md` §9; `docs/web/04-feature-components.md` §3 | Comportamento de reordenação JS interop puro é copiável; a chamada real a `store.ReorderAsync` vira handler local no Lab. |
...
| FE33-105 | JS interop | `wwwroot/js/beeday-sortable.js` | `acce26a` | ver FE33-038 | ADAPT | `<LabWeb>/wwwroot/js/` | 33.8 | MAPPED | `docs/web/README.md` "Achados" | Cache-busting por query string hardcoded — não copiar o débito, ver nota de qualidade em ADR-008 §Consequências negativas se aplicável na extração real. |
| FE33-106 | JS interop | `wwwroot/js/beeday-dialog-focus.js` | `acce26a` | `DialogFocusScope.cs` (ver FE33-034) | COPY | `<LabWeb>/wwwroot/js/` | 33.8 | MAPPED | `src/BeeDay.Web/Components/DesignSystem/Modals/DialogFocusScope.cs` | Focus trap de modal — comportamento presentation-only real. |
| FE33-107 | JS interop | `wwwroot/js/beeday-card-menu.js` | `acce26a` | posicionamento de menu de card | COPY | `<LabWeb>/wwwroot/js/` | 33.8 | MAPPED | `docs/design-system/README.md` "Achados" | |
